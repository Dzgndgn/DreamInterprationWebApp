...
namespace DreamAI.Migrations
{
    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "dreamInterpretes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DreamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SymbolsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ThemesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Advices = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    createdTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dreamInterpretes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_dreamInterpretes_dreams_DreamId",
                        column: x => x.DreamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dreamInterpretes_DreamId",
                table: "dreamInterpretes",
                column: "DreamId");
        }
